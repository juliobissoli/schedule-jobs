...
import CollaboratorSheetAssociateForm from "./sheet-associate-form";
...
export default function CollaboratorsJobsList({ collaboratorId }: { collaboratorId: string }) {
    ...
    return (
        <>
            <CollaboratorSheetAssociateForm collaboratorId={collaboratorId} onSuccess={getJob}>
                <Button className="w-full py-8" variant={'outline'}>
                    Associar nova jornada
                </Button>
